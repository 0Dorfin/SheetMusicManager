...
{
    partial class AllSheetsControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            lblPartituras.Location = new Point(345, 100);
            lblPartituras.Name = "lblPartituras";
            lblPartituras.Size = new Size(263, 38);
            lblPartituras.TabIndex = 11;
            lblPartituras.Text = "Explorar partituras";
            // 
            // panelOpciones
            // 
            ...
            panelPartitura.Controls.Add(labelCompositorP);
            panelPartitura.Controls.Add(labelNombreP);
            panelPartitura.Controls.Add(pictureBoxPartitura);
            panelPartitura.Location = new Point(3, 3);
            ...
            // labelEpocaP
            // 
            labelEpocaP.AutoSize = true;
            labelEpocaP.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point, 0);
            labelEpocaP.ForeColor = Color.Black;
            labelEpocaP.Location = new Point(4, 597);
            labelEpocaP.Margin = new Padding(2, 0, 2, 0);
            labelEpocaP.Name = "labelEpocaP";
            labelEpocaP.Size = new Size(65, 28);
            labelEpocaP.TabIndex = 19;
            labelEpocaP.Text = "Época";
            // 
            // labelInstrumentosP
            // 
            labelInstrumentosP.AutoSize = true;
            labelInstrumentosP.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point, 0);
            labelInstrumentosP.ForeColor = Color.Black;
            labelInstrumentosP.Location = new Point(4, 677);
            labelInstrumentosP.Margin = new Padding(2, 0, 2, 0);
            labelInstrumentosP.Name = "labelInstrumentosP";
            labelInstrumentosP.Size = new Size(126, 28);
            labelInstrumentosP.TabIndex = 18;
            labelInstrumentosP.Text = "Instrumentos";
            // 
            // labelAgrupacionP
            // 
            labelAgrupacionP.AutoSize = true;
            labelAgrupacionP.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point, 0);
            labelAgrupacionP.ForeColor = Color.Black;
            labelAgrupacionP.Location = new Point(4, 637);
            labelAgrupacionP.Margin = new Padding(2, 0, 2, 0);
            labelAgrupacionP.Name = "labelAgrupacionP";
            labelAgrupacionP.Size = new Size(114, 28);
            labelAgrupacionP.TabIndex = 17;
            labelAgrupacionP.Text = "Agrupacion";
            // 
            // labelCompositorP
            // 
            labelCompositorP.AutoSize = true;
            labelCompositorP.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point, 0);
            labelCompositorP.ForeColor = Color.Black;
            labelCompositorP.Location = new Point(2, 557);
            labelCompositorP.Margin = new Padding(2, 0, 2, 0);
            labelCompositorP.Name = "labelCompositorP";
            labelCompositorP.Size = new Size(116, 28);
            labelCompositorP.TabIndex = 16;
            labelCompositorP.Text = "Compositor";
            // 
            // labelNombreP
            // 
            labelNombreP.AutoSize = true;
            labelNombreP.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            labelNombreP.ForeColor = Color.FromArgb(61, 76, 158);
            labelNombreP.Location = new Point(2, 517);
            labelNombreP.Margin = new Padding(2, 0, 2, 0);
            labelNombreP.Name = "labelNombreP";
            labelNombreP.Size = new Size(102, 32);
            labelNombreP.TabIndex = 15;
            labelNombreP.Text = "Nombre";
            // 
            // pictureBoxPartitura
            // 
            pictureBoxPartitura.Location = new Point(0, 0);
            pictureBoxPartitura.Name = "pictureBoxPartitura";
            pictureBoxPartitura.Size = new Size(386, 500);
            ...
            flowLayoutPanelPartituras.ResumeLayout(false);
        ...
        private FlowLayoutPanel flowLayoutPanelPartituras;
        private Panel panelPartitura;
        private PictureBox pictureBoxPartitura;
        private Label labelNombreP;
        private Label labelCompositorP;
        private Label labelInstrumentosP;
        private Label labelAgrupacionP;
